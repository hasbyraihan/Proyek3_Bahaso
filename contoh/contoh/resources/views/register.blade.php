    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="register_store" method="post" enctype="multipart/form-data">
          ...
          <!-- Nama input -->
          <div class="form-outline mb-3">
            <input name="nama_users" type="text" id="form3Example4" class="form-control form-control-lg"
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Sudah mempunyai akun? <a href="/login_aja"
                class="link-primary">Masuk</a></p>
          </div>
